...
OPENROUTER_MODELS: list[tuple[str, str]] = [
    ...
    for mid in (
        "anthropic/claude-fable-5-1", "anthropic/claude-fable-5.1", "anthropic/claude-fable-5", "anthropic/claude-opus-5",
...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "anthropic": [
        "claude-fable-5-1", "claude-fable-5.1", "claude-fable-5", "claude-opus-5", "claude-sonnet-5",
